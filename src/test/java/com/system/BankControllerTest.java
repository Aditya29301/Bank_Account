...
import com.system.controller.BankController;
import com.system.entity.BankAccount;
import com.system.service.BankService;
...
class BankControllerTest {
	...
	void testgetAccounts() throws Exception {
		...
		BankAccount b1 = new BankAccount(1, "Saving",4000,null);
		BankAccount b2 = new BankAccount(2, "Current",2000,null);
		...
		mockMvc.perform(get("/accounts"))
				...
				.andExpect(jsonPath("$.data[0].accBalance").value(4000))
				.andExpect(jsonPath("$.data[1].accid").value(2))
				.andExpect(jsonPath("$.data[1].accType").value("Current"))
				.andExpect(jsonPath("$.data[1].accBalance").value(2000));
	...
	{
		BankAccount sa = new BankAccount(1,"Saving",1000,null);
		BankAccount da = new BankAccount(2,"Current",2000,null);
		int amount = 1000;
